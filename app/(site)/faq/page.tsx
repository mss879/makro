...
const DESCRIPTION =
  "Answers to common questions about buying, investing and living in a Makro development — apartment purchases in Colombo, foreign ownership and payment plans.";

export const metadata = pageMetadata({
  title: "FAQ — Buying & Investing in Sri Lanka",
