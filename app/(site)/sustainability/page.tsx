...
const DESCRIPTION =
  "Sustainable property development in Sri Lanka — climate-conscious projects with passive cooling, solar-ready services and durable materials for lasting value.";
