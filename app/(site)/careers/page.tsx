...
const DESCRIPTION =
  "Build a career with Makro Developers — a Sri Lankan property developer backed by the Wheels Lanka Group. Roles across engineering, design, sales and operations.";
